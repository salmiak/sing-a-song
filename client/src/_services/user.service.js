...
function forgotPassword(email) {
  ...
  return fetch(`${apiUrl}/users/forgot-password`, requestOptions).then(
    handleResponse
  );
}
...
function validateResetToken(token) {
  ...
  return fetch(`${apiUrl}/users/validate-reset-token`, requestOptions).then(
    handleResponse
  );
}
...
function resetPassword(payload) {
  ...
  return fetch(`${apiUrl}/users/reset-password`, requestOptions).then(
    handleResponse
  );
}
