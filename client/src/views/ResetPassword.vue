<template>
  <form-view title="Återställ lösen" @submitted="handleSubmit">
    <v-alert v-if="!tokenStatus" type="info">
      Laddar...
    </v-alert>
    ...
    <v-alert v-if="tokenStatus === 'invalid'" type="error">
...
<script>
  ...
  export default {
    ...
    created() {
      this.$store
        .dispatch("authentication/validateResetToken", { token: this.token })
        .then(
          () => {
