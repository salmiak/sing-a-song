<template>
  <v-container>
    <v-row class="justify-center mt-8 mb-8">
      <v-col style="max-width: 33em;">
        <h1 class="text-overline text-center">Singasong.nu</h1>
        <h2 class="text-center mb-8">
          Mötesplatsen för singer-songwriters, vissångare och arrangörer
        </h2>
        <p>
        ...
        <p class="text-center mt-12">
          <a href="https://visanisverige.se/" target="_blank"
            ><svg
              class="logo"
              version="1.1"
              id="Lager_1"
