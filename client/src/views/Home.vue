<template>
  <div>
    ...
    <v-parallax :src="require('../assets/frontpage-hero.jpg')" class="px-3">
      ...
      <v-container class="d-flex align-center flex-grow-1">
        <v-row justify="center" class="mb-8">
          <v-col class="col-12 col-sm-10 col-md-8 col-lg-6 pb-12 text-center">
            ...
            <v-menu max-height="256">
              ...
              <v-list>
                <v-list-item-group v-model="selectedArea" color="primary">
                  <v-list-item v-for="area in areas" :key="area" :value="area">
    ...
    <v-container class="pb-16">
      <v-row v-if="profiles.loading || profiles.error" class="text-center">
        <v-col>
          <p v-if="profiles.loading" class="text-center text-h4 mt-16">
            Laddar profiler…
          </p>
          <v-alert type="error" v-if="profiles.error">
